...
class ChooseRole extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .text(centerX, centerY - 150, "Escolha seu papel", {
        fontSize: "28px",
        fill: "#FFD700",
    ...
    let professorButton = this.add
      .sprite(centerX, centerY - 50, "painel")
      .setScale(1.2, 1.2)
      .setInteractive();
    let alunoButton = this.add
      .sprite(centerX, centerY + 50, "painel")
      .setScale(1.2, 1.2)
      .setInteractive();
    alunoButton.on("pointerdown", () => this.scene.start("Conversation"));
    let voltarButton = this.add
      .sprite(centerX, centerY + 150, "painel")
      .setScale(1.2, 1.2)
      .setInteractive();

    let professorText = this.add
      .text(centerX, centerY - 50, "Professor", {
        fontSize: "18px",
        fill: "#FFFFFF",
    ...
    let alunoText = this.add
      .text(centerX, centerY + 50, "Aluno", {
        fontSize: "18px",
        fill: "#FFFFFF",
        fontFamily: "OldSchoolAdventures",
        resolution: 10,
    ...
    let voltarText = this.add
      .text(centerX, centerY + 150, "Voltar", {
        fontSize: "18px",
        fill: "#FFFFFF",
        fontFamily: "OldSchoolAdventures",
        resolution: 10,
