...
export default class MenuPrincipal extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio("botao", "assets/sons/efeitos/botao.mp3"); // Adicionando o som do botão
  }
  ...
  createButton(x, y, text, callback) {
    ...
    let texto = this.add
      .text(x, y, text, {
        fontSize:
          Math.min(this.cameras.main.width, this.cameras.main.height) * 0.032, // Tamanho do texto menor (ajustado para 0.04)
        fill: "#FFFFFF",
  ...
  iniciarJogo() {
    ...
    this.tweens.add({
      ...
      ease: "Power2",
      onComplete: () => {
        this.scene.start("SelecaoPersonagem"); // Atualizado para o novo nome da cena
      },
    });
  }
