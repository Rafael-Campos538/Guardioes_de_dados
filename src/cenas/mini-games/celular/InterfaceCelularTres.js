export default class InterfaceCelularTres extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.image("mensagem_clauudia", "assets/imagens/celular/mensagem_clauudia.png");
      this.load.image("mensagem_rafaeel", "assets/imagens/celular/mensagem_rafaeela.png");
      this.load.image("mensagem_gabriela", "assets/imagens/celular/mensagem_gabriela.png");
      this.load.image("mensagem_luiz", "assets/imagens/celular/mensagem_luiz.png");
    ...
    atualizarCena() {
      ...
      this.criarMensagem(centerX, centerY - altura * 0.2, "mensagem_clauudia", "eoxisClauudia");
      this.criarMensagem(centerX, centerY - altura * 0.057, "mensagem_rafaeel", "eoxisRafaeel");
      this.criarMensagem(centerX, centerY + altura * 0.08, "mensagem_gabriela", "eoxisGabriela");
      this.criarMensagem(centerX, centerY + altura * 0.222, "mensagem_luiz", "eoxisLuiz");
    ...
    mostrarFeedback(isCorreto, eoxisKey) {
      ...
      const mensagens = {
        eoxisClauudia: "Boa! Não se deve pedir ou perguntar a religião de outras pessoas em nenhum momento.",
        eoxisRafaeel: "Boa! Você jamais deve expor sua religião a outras pessoas.",
        eoxisGabriela: "Boa! Um email não é considerado um dado sensível, mas deve ser pedido apenas com uma justificativa válida. ",
        eoxisLuiz: "EXCELENTE! Essa mensagem mostrava religião e email, onde religião jamais deve ser exposta e email apenas com uma justificativa válida.",
      };
  
      const mensagemTexto = mensagens[eoxisKey] || "Boa! Você excluiu corretamente uma mensagem sensível.";
